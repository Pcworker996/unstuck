...
gcloud run deploy "$SERVICE" \
  ...
  --set-env-vars \
"FIREBASE_PROJECT_ID=$PROJECT_ID,GOOGLE_CLOUD_LOCATION=$REGION,VERTEX_GEMINI_MODEL_ID=gemini-3.5-flash,GOOGLE_DAILY_MODEL_ACCOUNT_LIMIT=100,GOOGLE_DAILY_MODEL_GLOBAL_LIMIT=1000,GOOGLE_DAILY_ARTIFACT_ACCOUNT_LIMIT=10,GOOGLE_DAILY_ARTIFACT_GLOBAL_LIMIT=100"
~~~
